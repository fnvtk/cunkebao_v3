...
import type { WechatGroup } from "@/types/group-sync"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-medium">推送社群:</span>
          </div>
        ...
        {selectedGroups.length > 0 ? (
                ...
                <TableRow key={group.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">{group.serviceAccount.name}</span>
                    </div>
                  </TableCell>
                  <TableCell>
                    <Button
          ...
          <div className="border rounded-md p-8 text-center text-gray-500">请点击"选择微信聊天群"按钮添加群组</div>
        )}
      </div>
              ...
              <TableBody>
                {filteredGroups.map((group, index) => (
                  <TableRow key={group.id}>
                    ...
                    <TableCell>{group.serviceAccount.name}</TableCell>
                    <TableCell>
                      <Button
                        variant="outline"
                        size="sm"
